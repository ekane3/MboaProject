        ...
        <li>
          <ul class="collapsible collapsible-accordion">
            <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-tachometer-alt"></i>
                Administrateur<i class="fas fa-angle-down rotate-icon"></i></a>
            ...
            <!-- Simple link -->
            <li><a href="../alerts/alerts.html" class="collapsible-header waves-effect"><i class="fas fa-sign-in-alt"></i>
                Inscrire un étudiant</a>
            </li>
            <li><a href="../alerts/alerts.html" class="collapsible-header waves-effect"><i class="fas fa-eye"></i>
