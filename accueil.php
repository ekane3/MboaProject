            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                while($data = $requete->fetch()){
                 ...
                 echo '<td><button class="btn btn-sm btn-rounded btn-outline-danger waves-effect" data-toggle="modal" data-target="#reserve">Reserver</button></td>'
                 .'</tr>';
                 $i++;
               }    
               ?>
        ...
        <div class="container">
          ...
          <div class="table-responsive">
            <table class="table table-striped" >
              ...
              <tbody>
               <?php
               $requete = $bdd->query('SELECT c.heure_debut as heured,c.heure_fin as heuref,date_cours,nom_cours,s.nom_salle as salle,s.nbre_place_total as placetotal,s.nbre_place_occupee as placeoccupee
                FROM cours as co 
                INNER JOIN creneau as c on c.id = co.id_creneau 
                INNER JOIN salle as s on s.id = co.id_salle 
                ORDER BY date_cours ASC');
