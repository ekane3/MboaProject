  ...
  session_start();
   include("connexion.php");
    if ( isset($_SESSION['statut']) && isset($_SESSION['token']) && isset($_SESSION['token_time']) &&  $_SESSION['statut']=='admin' ) {
     $st = $bdd->query("SELECT nom_salle,id FROM salle ");
     $st->execute();
     
     $cr =  $bdd->query("SELECT heure_debut,heure_fin,id FROM creneau ");
     $cr->execute();
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="md-form">
                <select class="browser-default custom-select">
                  ...
                  <?php
                  foreach ($st as $donnees){
                   echo '<option value="'.$donnees['id'].'"> '.$donnees['nom_salle'].'  </option>'; 
                   }?>
                </select>
            ...
            <div class="col-md-6 ">
                ...
                <?php
                  foreach ($cr as $donnees){
                   echo '<option value="'.$donnees['id'].'"> '.$donnees['heure_debut'] .":".$donnees['heure_fin'] .'  </option>'; 
                   }?>
                </select>
          ...
          <div class="row">
            ...
            <div class="col-md-6 ">
              <div class="md-form">
                 <select class="browser-default custom-select">
                  ...
                  <option value="1">ATF TP1</option>
                  <option value="2">ATF TD</option>
                  <option value="3">Analyse Numérique</option>
                  <option value="4">ATF TP</option>
                  <option value="5">PA MArketing</option>
                  <option value="6">Modelisation des systemes</option>
                  <option value="7">PA gestion Projet</option>
                  <option value="8">Modelisation des Systemes TD</option>
                  <option value="9">PA Droit</option>
                  <option value="10">Modelisation des Systemes TP</option>
                </select>
              </div>
            </div>
            <!-- Grid column -->
            ...
            <div class="col-md-6 ">
              ...
              <div class="md-form">
                ...
                <label for="form1" class="">Date du cours </label>
              </div>
